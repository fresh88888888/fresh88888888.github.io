...
{% asset_img ml_4.png "模型在任务(General Autonomy + SWAA + RE-Bench)上的成功率表现" %}

接下来画了一下模型的成功率与人类需要解决这类任务所花费的时间的关系图，这也是一个负相关的曲线。如下图所示，如果人类在这类任务上花费的时间比较多，说明这类任务是比较难的任务，所以模型模型的成功率就比较低。
{% asset_img ml_5.png "模型的成功率与人类需要解决这类任务所花费的时间" %}
