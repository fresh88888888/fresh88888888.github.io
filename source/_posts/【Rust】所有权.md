...
{% asset_img padovan-mem-like.png %}
...
{% asset_img composers-mem-like.png %}
...
{% asset_img rust-value-initialize.png [s初始化] %}


但是在将 `s` 赋值给 `t` 之后，我们看到值的所有权转移了：

{% asset_img rust-value-move.png [值得所有权从s转移至t] %}
...
{% asset_img py-value-initialize.png [s初始化] %}
{% asset_img py-value-ref.png [s赋值给t和u] %}
...
{% asset_img cplusplus-assign.png %}
...
{% asset_img string-int-move-cmp.png %}
...
{% asset_img rc-arc-value-mme-layout.png %}
